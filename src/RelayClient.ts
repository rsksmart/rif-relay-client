import { EnvelopingTransactionDetails, ESTIMATED_GAS_CORRECTION_FACTOR } from '@rsksmart/rif-relay-common';
...
class RelayClient {
    ...
    private _applyGasCorrectionFactor(estimation: BigNumberish): BigNumber {
        ...
        const bigGasCorrection = BigNumberJs(ESTIMATED_GAS_CORRECTION_FACTOR.toString());
